...
Magnetfeld wird die Entartung der Energieniveaus entsprechend des anomalen
Zeeman-Effekts aufgehoben und wir können im Interferometer mehrere
...
Somit lässt sich ein Mittelwert über alle drei Messreihen bilden und wir erhalten für das Bohrsche Magneton folgenden Wert: $9,162 \cdot 10^{-24}~ \frac{J}{T} \pm 0,294 \cdot 10^{-24}~ \frac{J}{T}$ bzw. $9,162 \cdot 10^{-24}~ \frac{J}{T}\pm 3,21 \% $.


\chapter{Fazit}

Bei der qualitativen Überprüfung der klassischen Erklärung des Zeeman-Effektes treten keine Probleme auf bzw. mit den zur Verfügung stehenden Messinstrumenten kann das Modell eindeutig bestätigt werden. 
