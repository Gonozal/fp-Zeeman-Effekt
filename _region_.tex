\message{ !name(Versuch-1.5-Zeeman-Effekt.tex)}
\message{ !name(Versuch-1.5-Zeeman-Effekt.tex) !offset(99) }
...
Magnetfeld, welches wir mit Hilfe einer Hall-sonder bestimmen, noch das
...
Filters die sichtbaren Spektrallinien reduziert werden. Dazu stehen uns Filter
mit Wellenlängen von $405 nm \pm 1%$, $436 nm \pm 1%$ und $546 nm \pm 1%$
zur verfügung, was bei der verwendeten Quecksilberdampflampe den Übergängen von
$2^3S_1$ nach $2^3P_0$, $2^3P_1$ und $2^3P_2$ entspricht. Durch das angelegte
...
\message{ !name(Versuch-1.5-Zeeman-Effekt.tex) !offset(-357) }
